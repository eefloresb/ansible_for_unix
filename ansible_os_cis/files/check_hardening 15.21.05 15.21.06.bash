...
comando2=$(lsmod | grep vfat)

if [ -z "$comando2" ]; then
echo -e "1.1.1.2 Ensure mounting of vFAT filesystems is limited:\e[1;32m OK \e[0m"
else
echo -e "1.1.1.2 Ensure mounting of vFAT filesystems is limited:\e[1;31m FAIL \e[0m"
fi

#1.1.1.3 Ensure mounting of squashfs filesystems is disabled

comando3=$(lsmod | grep squashfs)

if [ -z "$comando3" ]; then
echo -e "1.1.1.3 Ensure mounting of squashfs filesystems is disabled:\e[1;32m OK \e[0m"
else
echo -e "1.1.1.3 Ensure mounting of squashfs filesystems is disabled:\e[1;31m FAIL \e[0m"
fi

#1.1.1.4 Ensure mounting of udf filesystems is disabled

comando4=$(lsmod | grep udf)

if [ -z "$comando4" ]; then
echo -e "1.1.1.4 Ensure mounting of udf filesystems is disabled:\e[1;32m OK \e[0m"
else
echo -e "1.1.1.4 Ensure mounting of udf filesystems is disabled:\e[1;31m FAIL \e[0m"
fi

#1.1.2 Ensure /tmp is configured

comando5=$(mount | grep -E '\s/tmp\s')

if [ ! -z "$comando5" ]; then
echo -e "1.1.2 Ensure /tmp is configured:\e[1;32m OK \e[0m"
else
echo -e "1.1.2 Ensure /tmp is configured:\e[1;31m FAIL \e[0m"
fi

#1.1.3 Ensure nodev option set on /tmp partition

comando6=$(mount | grep -E '\s/tmp\s' | grep nodev)

if [ ! -z "$comando6" ]; then
echo -e "1.1.3 Ensure nodev option set on /tmp partition:\e[1;32m OK \e[0m"
else
echo -e "1.1.3 Ensure nodev option set on /tmp partition:\e[1;31m FAIL \e[0m"
fi

#1.1.4 Ensure nosuid option set on /tmp partition

comando7=$(mount | grep -E '\s/tmp\s' | grep nosuid)

if [ ! -z "$comando7" ]; then
echo -e "1.1.4 Ensure nosuid option set on /tmp partition:\e[1;32m OK \e[0m"
else
echo -e "1.1.4 Ensure nosuid option set on /tmp partition:\e[1;31m FAIL \e[0m"
fi

#1.1.5 Ensure noexec option set on /tmp partition

comando8=$(mount | grep -E '\s/tmp\s' | grep noexec)

if [ ! -z "$comando8" ]; then
echo -e "1.1.5 Ensure noexec option set on /tmp partition:\e[1;32m OK \e[0m"
else
echo -e "1.1.5 Ensure noexec option set on /tmp partition:\e[1;31m FAIL \e[0m"
fi

#1.1.6 Ensure separate partition exists for /var

comando9=$(mount | grep -E '\s/var\s')

if [ ! -z "$comando9" ]; then
echo -e "1.1.6 Ensure separate partition exists for /var:\e[1;32m OK \e[0m"
else
echo -e "1.1.6 Ensure separate partition exists for /var:\e[1;31m FAIL \e[0m"
fi

#1.1.7 Ensure separate partition exists for /var/tmp

comando10=$(mount | grep /var/tmp)

if [ ! -z "$comando10" ]; then
echo -e "1.1.7 Ensure separate partition exists for /var/tmp:\e[1;32m OK \e[0m"
else
echo -e "1.1.7 Ensure separate partition exists for /var/tmp:\e[1;31m FAIL \e[0m"
fi

#1.1.8 Ensure nodev option set on /var/tmp partition

comando11=$(mount | grep -E '\s/var/tmp\s' | grep nodev)

if [ ! -z "$comando11" ]; then
echo -e "1.1.8 Ensure nodev option set on /var/tmp partition:\e[1;32m OK \e[0m"
else
echo -e "1.1.8 Ensure nodev option set on /var/tmp partition:\e[1;31m FAIL \e[0m"
fi

#1.1.9 Ensure nosuid option set on /var/tmp partition

comando12=$(mount | grep -E '\s/var/tmp\s' | grep nosuid)

if [ ! -z "$comando12" ]; then
echo -e "1.1.9 Ensure nosuid option set on /var/tmp partition:\e[1;32m OK \e[0m"
else
echo -e "1.1.9 Ensure nosuid option set on /var/tmp partition:\e[1;31m FAIL \e[0m"
fi

#1.1.10 Ensure noexec option set on /var/tmp partition

comando13=$(mount | grep -E '\s/var/tmp\s' | grep noexec)

if [ ! -z "$comando13" ]; then
echo -e "1.1.10 Ensure noexec option set on /var/tmp partition:\e[1;32m OK \e[0m"
else
echo -e "1.1.10 Ensure noexec option set on /var/tmp partition:\e[1;31m FAIL \e[0m"
fi

#1.1.11 Ensure separate partition exists for /var/log

comando14=$(mount | grep /var/log)

if [ ! -z "$comando14" ]; then
echo -e "1.1.11 Ensure separate partition exists for /var/log:\e[1;32m OK \e[0m"
else
echo -e "1.1.11 Ensure separate partition exists for /var/log:\e[1;31m FAIL \e[0m"
fi

#1.1.12 Ensure separate partition exists for /var/log/audit

comando15=$(mount | grep /var/log/audit)

if [ ! -z "$comando15" ]; then
echo -e "1.1.12 Ensure separate partition exists for /var/log/audit:\e[1;32m OK \e[0m"
else
echo -e "1.1.12 Ensure separate partition exists for /var/log/audit:\e[1;31m FAIL \e[0m"
fi

#1.1.13 Ensure separate partition exists for /home

comando16=$(mount | grep /home)

if [ ! -z "$comando16" ]; then
echo -e "1.1.13 Ensure separate partition exists for /home:\e[1;32m OK \e[0m"
else
echo -e "1.1.13 Ensure separate partition exists for /home:\e[1;31m FAIL \e[0m"
fi

#1.1.14 Ensure nodev option set on /home partition

comando17=$(mount | grep -E '\s/home\s' | grep nodev)

if [ ! -z "$comando17" ]; then
echo -e "1.1.14 Ensure nodev option set on /home partition:\e[1;32m OK \e[0m"
else
echo -e "1.1.14 Ensure nodev option set on /home partition:\e[1;31m FAIL \e[0m"
fi

#1.1.15 Ensure nodev option set on /dev/shm partition

comando18=$(mount | grep -E '\s/dev/shm\s' | grep nodev)

if [ ! -z "$comando18" ]; then
echo -e "1.1.15 Ensure nodev option set on /dev/shm partition:\e[1;32m OK \e[0m"
else
echo -e "1.1.15 Ensure nodev option set on /dev/shm partition:\e[1;31m FAIL \e[0m"
fi

#1.1.16 Ensure nosuid option set on /dev/shm partition

comando19=$(mount | grep -E '\s/dev/shm\s' | grep nosuid)

if [ ! -z "$comando19" ]; then
echo -e "1.1.16 Ensure nosuid option set on /dev/shm partition:\e[1;32m OK \e[0m"
else
echo -e "1.1.16 Ensure nosuid option set on /dev/shm partition:\e[1;31m FAIL \e[0m"
fi

#1.1.17 Ensure noexec option set on /dev/shm partition

comando20=$(mount | grep -E '\s/dev/shm\s' | grep noexec)

if [ ! -z "$comando20" ]; then
echo -e "1.1.17 Ensure noexec option set on /dev/shm partition:\e[1;32m OK \e[0m"
else
echo -e "1.1.17 Ensure noexec option set on /dev/shm partition:\e[1;31m FAIL \e[0m"
fi

#1.1.21 Ensure sticky bit is set on all world-writable directories

comando21=$(df --local -P | awk '{if (NR!=1) print $6}' | xargs -I '{}' find '{}' -xdev -type d \( -perm -0002 -a ! -perm -1000 \) 2>/dev/null)

if [ -z "$comando21" ]; then
echo -e "1.1.21 Ensure sticky bit is set on all world-writable directories:\e[1;32m OK \e[0m"
else
echo -e "1.1.21 Ensure sticky bit is set on all world-writable directories:\e[1;31m FAIL \e[0m"
fi

#1.1.22 Disable Automounting

comando22=$(systemctl is-enabled autofs 2>&1 > /dev/null)

if [ "$?" -eq 1 ] || [ $comando22 == "disabled" ]; then
echo -e "1.1.22 Disable Automounting:\e[1;32m OK \e[0m"
else
echo -e "1.1.22 Disable Automounting:\e[1;31m FAIL \e[0m"
fi

#1.1.23 Disable USB Storage

comando23=$(lsmod | grep usb-storage)

if [ -z "$comando23" ]; then
echo -e "1.1.23 Disable USB Storage:\e[1;32m OK \e[0m"
else
echo -e "1.1.23 Disable USB Storage:\e[1;31m FAIL \e[0m"
fi

#1.2.1 Ensure Red Hat Subscription Manager connection is configured

comando24=$(subscription-manager identity 2>&1 > /dev/null)

if [ "$comando24" != "This system is not yet registered. Try 'subscription-manager register --help' for more information." ]; then
...
comando25=$(systemctl is-enabled rhnsd 2>&1 > /dev/null)

if [ "$comando25" == "disabled" ]; then
echo -e "1.2.2 Disable the rhnsd Daemon:\e[1;32m OK \e[0m"
else
echo -e "1.2.2 Disable the rhnsd Daemon:\e[1;31m FAIL \e[0m"
fi

#1.2.3 Ensure GPG keys are configured

comando26=$(rpm -q gpg-pubkey --qf '%{name}-%{version}-%{release} --> %{summary}\n' 2>&1 > /dev/null)

if [ "$?" -eq 0 ]; then
echo -e "1.2.3 Ensure GPG keys are configured:\e[1;32m OK \e[0m"
else
echo -e "1.2.3 Ensure GPG keys are configured:\e[1;31m FAIL \e[0m"
fi

#1.2.4 Ensure gpgcheck is globally activated

comando27=$(grep ^gpgcheck /etc/yum.conf)

if [ "$comando27" == "gpgcheck=1" ]; then
echo -e "1.2.4 Ensure gpgcheck is globally activated:\e[1;32m OK \e[0m"
else
echo -e "1.2.4 Ensure gpgcheck is globally activated:\e[1;31m FAIL \e[0m"
fi

#1.2.5 Ensure package manager repositories are configured

comando28=$(dnf -q repolist)

if [ ! -z "$comando28" ]; then
echo -e "1.2.5 Ensure package manager repositories are configured:\e[1;32m OK \e[0m"
else
echo -e "1.2.5 Ensure package manager repositories are configured:\e[1;31m FAIL \e[0m"
fi
